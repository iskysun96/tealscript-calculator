...
import { TealscriptCalculatorClient } from '../contracts/clients/TealscriptCalculatorClient';

const fixture = algorandFixture();

let appClient: TealscriptCalculatorClient;

describe('TealscriptCalculator', () => {
  ...
  beforeAll(async () => {
    ...
    appClient = new TealscriptCalculatorClient(
      {
        sender: testAccount,
        resolveBy: 'id',
        id: 0,
